...
const options: BeautifierOptions = {
  JavaScript: {
    ...
    // "block-spacing": [   [""],   (options): any => {   } ], "brace-style": [
    // ["brace_style"],   (options): any => {
    //
    ...
    // "comma-style": [   [""],   (options): any => {   } ],
    // "computed-property-spacing": [   [""],   (options): any => {   } ],
    // "eol-last": [   [""],   (options): any => {   } ], "func-call-spacing": [
    // [""],   (options): any => {   } ], "function-paren-newline": [   [""],
    // (options): any => {   } ], "implicit-arrow-linebreak": [   [""],   (options):
    // any => {   } ], "indent": [   [""],   (options): any => {   } ],
    // "jsx-quotes": [   [""],   (options): any => {   } ], "key-spacing": [   [""],
    // (options): any => {   } ], "keyword-spacing": [   [""],   (options): any => {
    ...
    // "no-trailing-spaces": [   ["remove_trailing_whitespace"],   (options): any =>
    ...
    // "space-before-function-paren": [   [""],   (options): any => {   } ],
    // "space-in-parens": [   [""],   (options): any => {   } ], "space-infix-ops":
    // [   [""],   (options): any => {   } ], "space-unary-ops": [   [""],
    // (options): any => {   } ], "spaced-comment": [   [""],   (options): any => {
    // } ], "switch-colon-spacing": [   [""],   (options): any => {   } ],
    // "template-tag-spacing": [   [""],   (options): any => {   } ], "unicode-bom":
    // [   [""],   (options): any => {   } ], "wrap-regex": [   [""],   (options):
    // any => {   } ], "arrow-body-style": [   [""],   (options): any => {   } ],
    "arrow-parens": [
      ["arrow_parens"],
      (options): any => {
